...
Usage:
  ...
  [--hidden_size_char=<hsc>]  [--hidden_size_LSTM=<hsn>]
...
Options:
  ...
  --num_LSTM_layers         The number of LSTM units [default: 2]
  --num_layers_char         The number of LSTM units for char embedding [default: 2]
